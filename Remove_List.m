function [Population,pop_hiv,Rels_steady,steady_dur, alive_ind,infect_alive,reset_casual_prop,total_infect_undiagn_ind,total_diagn_ind,total_treat_ind,total_sup_ind]=Remove_List(Population,pop_hiv,Rels_steady,steady_dur,alive_ind,pop_index,hiv_index,ind_died,tcounter,infect_alive,total_infect_undiagn_ind,total_diagn_ind,total_treat_ind,total_sup_ind)
    ...
    if numel(ind_died)>0
        for ind=ind_died
            ...
            Population.Data(pop_index.death,ind)=(tcounter-mod(tcounter,year))/year;% update the time of death
            % retrieve their id
            ...
            if sp1_id~=-1 % if there is a partner in slot 1
                ...
                steady_dur.Data=[steady_dur.Data; tcounter-Population.Data(pop_index.sp1_stdate,ind)]; % record relationship duration
