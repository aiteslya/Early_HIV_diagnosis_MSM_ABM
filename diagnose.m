function [Pop_hiv, newly_diagn,prop_diagn_AHI,new_total_diagn_ind,new_AHI_diagn_ind]=diagnose(Pop_hiv,hiv_index,HIV_st,cfg,infect_old,prop_diagn_AHI,tcounter,cfg_screen,new_total_diagn_ind,new_AHI_diagn_ind)
...
% diagnosis, but not people who were just infected on the same day
    ...
    T_screen_d = year*cfg_screen.T_extra_s;

    upsilon_ahi1=cfg_screen.upsilon_ahi1;
    upsilon_ahi23=cfg_screen.upsilon_ahi23;
    upsilon_ahi45=cfg_screen.upsilon_ahi45;
    upsilon_ahi_c_6m=cfg_screen.upsilon_ahi_c_6m;
    upsilon_ahi_c_12m=cfg_screen.upsilon_ahi_c_12m;
