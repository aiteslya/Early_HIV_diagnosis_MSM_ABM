function [Pop_hiv, newly_diagn,prop_diagn_AHI,new_total_diagn_ind,new_AHI_diagn_ind]=diagnose_Load_No_ART(Pop_hiv,hiv_index,HIV_st,cfg,infect_old,prop_diagn_AHI,tcounter,cfg_screen,new_total_diagn_ind,new_AHI_diagn_ind)
