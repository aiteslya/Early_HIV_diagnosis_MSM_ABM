function [Pop_hiv,infect_alive,infect_source_data,infect_target_data, newly_infect]=infect_new_casual(Population,Pop_hiv,pop_index,hiv_index,cfg,infect_alive,tcounter,HIV_st,id1,id2,condom,infect_source_data,infect_target_data, newly_infect)
...
% during AI
    ...
    if (st1+st2)==1 & ((ismember(ind1,infect_alive.Data)) | (ismember(ind2, infect_alive.Data))) % exactly one person can transmit and they did not just enter the population
