function [Population, pop_hiv,fl_collect,num_died,alive_ind,steady_dur,casual_dur,Rels_steady,ind_died,infect_alive,reset_casual_prop,total_infect_undiagn_ind,total_diagn_ind,total_treat_ind,total_sup_ind, all_casual_parts]=Death_Load(Population,pop_hiv,fl_collect,pop_index,hiv_index,DeathProbs_d,tcounter,alive_ind,steady_dur,casual_dur,Rels_steady,infect_alive,total_infect_undiagn_ind,total_diagn_ind,total_treat_ind,total_sup_ind, all_casual_parts)
    ...
    if numel(alive_ind.Data)>0
        mu_arr=DeathProbs_d(Population.Data(pop_index.age_bin,alive_ind.Data)); % assess death rates for everyone, age-dependent
        r1_arr=rand(1,numel(alive_ind.Data));% roll the die
        ind_died=alive_ind.Data(r1_arr<(mu_arr));
    end

    % death due to the being too old
    if mod(tcounter+182,365)==0% a year has passed
    ...
    if numel(ind_died)>0
        ...
        [Population,pop_hiv,Rels_steady,steady_dur,alive_ind,infect_alive,reset_casual_prop,total_infect_undiagn_ind,total_diagn_ind,total_treat_ind,total_sup_ind] = Remove_List(Population,pop_hiv,Rels_steady,steady_dur, alive_ind,pop_index,hiv_index,ind_died,tcounter,infect_alive,total_infect_undiagn_ind,total_diagn_ind,total_treat_ind,total_sup_ind);
