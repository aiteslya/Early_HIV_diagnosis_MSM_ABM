...
% the parameters passed in cfg structure are probabilities per yer, need to
% be converted to probabilities per day
    year=365;
    % conversion of probabilities from per year to per day
    mu_eaD=cfg.mu_ea/year;
    mu_laD=cfg.mu_la/year;
