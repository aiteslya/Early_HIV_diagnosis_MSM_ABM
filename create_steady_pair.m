function [Population,s_fl,Rels_steady]=create_steady_pair(Population,pop_index,t_counter,Rels_steady,alive_ind,age_attr,sero_attr,Pop_hiv,hiv_index,all_casual_parts)
