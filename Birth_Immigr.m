...
function [Population,Pop_hiv,Id_counter,alive_ind,ind_new_bracket, new_infect3, new_diagn, new_suppr, infect_alive] = Birth_Immigr(Population,Pop_hiv,pop_index,hiv_index,lambda_d,tcounter,Id_counter,alive_ind, cfg, lambda_diagn_d, infect_alive, HIV_st)
